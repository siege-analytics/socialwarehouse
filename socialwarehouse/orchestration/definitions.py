...
from socialwarehouse.orchestration.assets import civic, demographic, economic, geo
...
defs = Definitions(
    assets=[*geo.all_assets, *civic.all_assets, *demographic.all_assets, *economic.all_assets],
    jobs=all_jobs,
