...
- **v3 (2026-05-19, F11 fully landed):** step 2 (PR #187), step 2b design (PR #197), step 2b implementation (PR #203), and step 3 caller audit (this PR) all merged. The cache is now formally "current-by-construction"; the helpers are the canonical surface for as-of-date and history; consumer audit (`docs/audits/f11-address-cache-consumers.md`) confirmed no caller migrations needed. F11 is complete. Sub-issue B (template-readiness vintage polymorphization, SW#190) is now unblocked per initiative SW#189.
