...
|---|---|---|
| `base.py` | shared defaults | `INSTALLED_APPS`, `MIDDLEWARE`, `DATABASES["default"]` from env vars |
...
- 2026-05-19: ST5 / SW#143 + ST6 / SW#144 — added contract comment to `ALLOWED_HOSTS = []` explaining environments override.
